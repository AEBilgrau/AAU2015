...
The leftmost plot is somewhat misleading as the limiting observation window come into play.
That the density taper off here is effectively an edge effect.
Looking at the rightmost plot, we see a slight dip in density of points near the center. This again indicate a regular point pattern, however, the data is somewhat sparse in the latter plot.
...
There seems to be no good evidence for any difference between the L funciton under the Poisson model and the ``japanesepines` point pattern.
